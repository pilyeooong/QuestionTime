            ...
            <div v-else-if="showForm">
                <form action="" class="card" @submit.prevent="onSubmit">
                    ...
                    <div class="card-block">
                        <textarea v-model="newsAnswerBody" rows="5" placeholder="Share Your Knowledge" class="form-control"></textarea>
                    </div>
...
export default {
    ...
    methods:{
        ...
        onSubmit(){
            if(this.newsAnswerBody){
                let endpoint = `/api/questions/${this.slug}/answer/`
                apiService(endpoint, "POST", { body: this.newsAnswerBody })
                    .then(data => {
                        this.answers.unshift(data)
                    })
                this.newsAnswerBody = null;
                this.showForm = false;
